...
/**
 * Upload a file to storage (alias for saveObject)
 */
export async function uploadFile(bucket: string, key: string, data: Buffer | string): Promise<string> {
  return saveObject(bucket, key, data);
}
